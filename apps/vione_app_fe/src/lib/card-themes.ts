...
export const CARD_THEMES: Record<CardThemeId, CardTheme> = {
  classic: {
    id: "classic",
    label: "Classic",
    surface: "linear-gradient(135deg,#14306a 0%,#0e1f44 55%,#0a1834 100%)",
    accent: "#e6c06a",
    accentSoft: "rgba(230,192,106,0.18)",
    text: "#f5f0e4",
    textMuted: "#9fb0d0",
    border: "rgba(216,178,99,0.22)",
    shine: true,
  },
  executive: {
    id: "executive",
  ...
  government: {
    id: "government",
    label: "Government",
    surface: "linear-gradient(135deg,#0b2545 0%,#08203f 55%,#04152b 100%)",
    accent: "#7fb2ff",
    accentSoft: "rgba(127,178,255,0.16)",
    text: "#eef4ff",
    textMuted: "#9db4d6",
    border: "rgba(127,178,255,0.22)",
    shine: false,
  },
  university: {
    id: "university",
