...
function ProfileScreen() {
  ...
  const menu = [
    ...
    { label: t("m.profile.menu_opportunities"), icon: Sparkles, to: "/association/opportunities" as const, desc: "Cơ hội giao thương B2B" },
    { label: t("m.profile.menu_products"), icon: Package, to: "/association/products" as const, desc: "Gian hàng sản phẩm" },
