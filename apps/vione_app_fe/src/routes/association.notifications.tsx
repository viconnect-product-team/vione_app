      ...
      <div className="mt-3.5 space-y-3 px-4" role="list" aria-live="polite" aria-busy={loading}>
        ...
        {visible.map((n: any) => {
          ...
          const typeTheme: Record<string, { iconBg: string; badge: string; label: string }> = {
            opportunity: {
              iconBg: "bg-sky-500/10 text-sky-600 dark:text-sky-300 border-sky-500/20",
          ...
          return (
            <div
              ...
              className={`relative flex gap-3.5 p-4 rounded-2xl border transition-all duration-200 shadow-xs hover:shadow-md overflow-hidden ${
                n.unread
                  ? "bg-sky-50/40 dark:bg-[#111726] border-sky-300/50 dark:border-sky-500/30 shadow-sm"
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-2 flex-wrap mb-1">
                  ...
                  <div className="flex items-center gap-1.5">
                    {n.unread && (
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-[var(--vba-gold-soft)] text-[var(--vba-gold)] border border-[var(--vba-border-accent)]">
