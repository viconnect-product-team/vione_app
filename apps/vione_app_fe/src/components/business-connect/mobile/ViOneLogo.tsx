...
export function ViOneLogo({ className }: { className?: string }) {
  return (
    <svg
      width="77"
      height="20"
    ...
    >
      ...
      <g clipPath="url(#vl_clip)">
        ...
        <path d="M15.2189 10.7617L12.4208 10.759L10.1465 14.6687L11.5464 17.075L15.2189 10.7617Z" fill="url(#vl_p2)"/>
        <path d="M10.1468 14.6687L7.87267 10.759L5.07422 10.7617L8.74708 17.0752L10.147 19.4814L11.5468 17.075L10.1468 14.6687Z" fill="url(#vl_p3)"/>
        ...
        <path d="M50.6412 4.83081C47.0746 4.83081 44.1836 7.7003 44.1836 11.2401C44.1836 14.7798 47.0748 17.6493 50.6412 17.6493C54.2076 17.6493 57.099 14.7798 57.099 11.2401C57.099 7.7003 54.2078 4.83081 50.6412 4.83081ZM50.6412 16.4765C47.7272 16.4765 45.3651 14.1321 45.3651 11.2401C45.3651 8.348 47.7272 6.00362 50.6412 6.00362C53.5552 6.00362 55.9173 8.348 55.9173 11.2401C55.9173 14.1321 53.5552 16.4765 50.6412 16.4765Z" fill="url(#vl_p19)"/>
        <path d="M50.6413 6.00366C47.7274 6.00366 45.3652 8.34804 45.3652 11.2401C45.3652 14.1322 47.7274 16.4766 50.6413 16.4766C53.5553 16.4766 55.9175 14.1322 55.9175 11.2401C55.9175 8.34804 53.5553 6.00366 50.6413 6.00366ZM50.6413 15.311C48.3761 15.311 46.5398 13.4884 46.5398 11.2403C46.5398 8.99221 48.3761 7.16941 50.6413 7.16941C52.9066 7.16941 54.7431 8.99204 54.7431 11.2403C54.7431 13.4885 52.9066 15.311 50.6413 15.311Z" fill="url(#vl_p20)"/>
        <path d="M50.6413 6.00366C47.7274 6.00366 45.3652 8.34804 45.3652 11.2401C45.3652 14.1322 47.7274 16.4766 50.6413 16.4766C53.5553 16.4766 55.9175 14.1322 55.9175 11.2401C55.9175 8.34804 53.5553 6.00366 50.6413 6.00366ZM50.6413 15.311C48.3761 15.311 46.5398 13.4884 46.5398 11.2403C46.5398 8.99221 48.3761 7.16941 50.6413 7.16941C52.9066 7.16941 54.7431 8.99204 54.7431 11.2403C54.7431 13.4885 52.9066 15.311 50.6413 15.311Z" fill="url(#vl_p21)"/>
      </g>
    </svg>
  );
}
