...
export const Route = createFileRoute("/association/renew/result")({
      ...
      if (!res.success) {
        toast.error(t("m.pay.resultFailTitle"), {
          ...
          action: {
            ...
            onClick: () => navigate({ to: "/association/renew/audit", search: { ref } }),
          },
        });
      } else {
        ...
        <div className="mt-8 w-full space-y-2.5">
          {ok ? (
            <>
              ...
              <button
                onClick={() => navigate({ to: "/association/card" })}
            ...
            <>
              ...
              <button
                onClick={() => navigate({ to: "/association/renew/pay" })}
                className="w-full rounded-xl border border-[var(--vba-border)] py-3.5 text-[14px] font-semibold text-[var(--vba-text)]"
              >
                {t("m.pay.tryAgain")}
              </button>
