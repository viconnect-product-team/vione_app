...
export const Route = createFileRoute("/install")({
  head: () => ({
    meta: [
      { title: "Cài đặt ứng dụng Hội viên CEO 1983 — CLB Doanh Nhân CEO 1983" },
      {
        name: "description",
        content:
          "Quét mã QR để cài đặt ứng dụng hội viên CEO 1983 lên màn hình chính. Hướng dẫn chi tiết cho iOS và Android.",
      },
    ],
  }),
      ...
      <div className="mx-auto w-full max-w-3xl px-5 py-10">
        ...
        <div className="flex flex-col items-center text-center">
          <img
            ...
            height={80}
          />
          <h1 className="mt-4 text-2xl font-extrabold vba-gold-text">CEO 1983 — Ứng dụng Hội viên</h1>
