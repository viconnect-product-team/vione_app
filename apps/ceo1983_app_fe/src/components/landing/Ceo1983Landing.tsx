...
const CEO1983_I18N = {
  vi: {
    ...
    timeDesc:
      "KỶ NGUYÊN NGHÌN TỶ • 6 TÒA THÁP TĂNG TRƯỞNG • SỐ HÓA CEO 1983",
...
export function Ceo1983Landing() {
  ...
  return (
    ...
    >
      ...
      {/* =======================================
          SECTION 1: HERO ORBITAL SHOWCASE (AI MALE & FEMALE EXECUTIVES + ORBITAL MENU)
          ======================================= */}
      <div id="hero">
        <Ceo1983OrbitalHero onOpenJoinModal={() => setModalOpen(true)} />
      </div>
