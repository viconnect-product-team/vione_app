    ...
    <div className="absolute inset-0 pointer-events-none overflow-hidden select-none z-0">
      ...
      >
        <img
          ...
          alt={`CEO 1983 ${sectionId} scenery background`}
...
export function BusinessConnectLanding() {
  ...
  const [themeMode, setThemeMode] = useState<ThemeMode>(() => {
    if (typeof window !== "undefined") {
      const saved = localStorage.getItem("ceo1983_bc_theme");
  ...
  const handleSetTheme = (mode: ThemeMode) => {
    ...
    setTimeout(() => {
      setThemeMode(mode);
      if (typeof window !== "undefined") {
        localStorage.setItem("ceo1983_bc_theme", mode);
      }
    }, 600);
    setTimeout(() => {
      setIsDoorOpen(true);
            ...
            <>
              ...
              >
                <img
                  ...
                  alt="CEO 1983 Business Connect Landmark Tower Skyline"
            ...
            <>
              ...
              >
                <img
                  ...
                  alt="CEO 1983 Business Connect Cosmos City"
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Giant Watermark Embossed CEO 1983 Globe */}
                        <div className="absolute right-4 top-1/2 -translate-y-1/2 w-44 h-44 rounded-full opacity-35 pointer-events-none flex items-center justify-center border-2 border-slate-950/40">
                          ...
                          <span className="font-sans font-black text-2xl text-slate-950/60 tracking-wider">
                            CEO 1983
                          </span>
                        </div>
                      ...
                      <div className="absolute inset-0 w-full h-full rounded-3xl p-5 sm:p-6 bg-gradient-to-br from-[#0B1020] via-[#050814] to-[#02050E] rotate-y-180 backface-hidden flex flex-col justify-between overflow-hidden border border-[#D8B282]/50 text-left">
                        ...
                        <div className="space-y-1.5">
                          ...
                          <p className="text-[10px] text-slate-300 leading-snug">
                            Chạm 1-lần vào điện thoại thông minh để trao đổi hồ sơ doanh nghiệp 360° đã được xác thực qua CEO 1983 Business Connect. Tự động lưu danh bạ và mở cơ hội đàm phán hợp đồng.
                          </p>
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
              ...
              <div className="lg:col-span-4 space-y-4 text-left border-l border-[#D8B282]/30 pl-0 lg:pl-8">
                ...
                <p className={`text-xs leading-relaxed font-medium ${themeClass("text-slate-300", "text-slate-700", "text-yellow-100")}`}>
                  Đội ngũ chuyên gia kỹ thuật của CEO 1983 hỗ trợ số hóa toàn diện danh bạ hội viên, cấu hình thẻ NFC và đào tạo ban thư ký sử dụng phần mềm.
                </p>
                <div className="pt-2">
      ...
      <footer className={`py-8 border-t text-xs font-mono transition-colors duration-500 ${themeClass(
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span>•</span>
            <span>CEO 1983 PLATFORM ECOSYSTEM</span>
          </div>
