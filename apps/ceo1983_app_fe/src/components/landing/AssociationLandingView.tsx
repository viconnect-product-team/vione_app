...
export function AssociationLandingView({ a }: { a: PublicAssociation }) {
  ...
  const products = isCeo1983
    ...
    : [
        {
          name: lang === "vi" ? "Gói Chuyển Đổi Số Doanh Nghiệp Enterprise AI" : "Enterprise AI Digital Transformation Package",
          ...
          <div className="mx-auto max-w-6xl px-5">
            <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[var(--vba-text-muted)]">· Hệ điều hành kết nối Hiệp Hội Doanh Nghiệp</span>
              </div>
            ...
            <div className="mt-6 border-t border-[var(--vba-border-soft)] pt-4 text-[11px] text-[var(--vba-text-muted)]">
              © {new Date().getFullYear()} {a.name}. Bảo lưu mọi quyền.
            </div>
          </div>
        </footer>
      </div>
