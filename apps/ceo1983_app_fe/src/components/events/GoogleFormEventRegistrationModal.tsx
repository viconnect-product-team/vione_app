    ...
    try {
      ...
      if (tmpl) {
        renderNotificationTemplate(tmpl, {
          ...
          qrCodeDataUrl: `https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=CEO1983-${generatedTicket}`,
        });
      }

      // Save into local registration list for mock or real sync
      if (typeof window !== "undefined") {
        const stored = JSON.parse(localStorage.getItem("ceo1983_event_custom_registrations") || "[]");
        stored.unshift({
          eventId: event.id,
          ticketCode: generatedTicket,
          ...form,
        ...
        localStorage.setItem("ceo1983_event_custom_registrations", JSON.stringify(stored));
      }
        ...
        <div className="sticky top-0 z-20 flex items-center justify-between border-b border-purple-200/50 bg-[#673ab7] px-5 py-3 text-white">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold tracking-wide">
              CEO 1983 Forms · Phiếu Thu Thập Thông Tin Đại Biểu
            </span>
          </div>
          <button
            onClick={onClose}
                  ...
                  <div className="rounded-xl border-2 border-dashed border-amber-300 bg-gradient-to-br from-amber-50/60 to-orange-50/40 p-5">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                      ...
                      <div className="text-center shrink-0">
                        <img
                          src={`https://api.qrserver.com/v1/create-qr-code/?size=130x130&data=CEO1983-${ticketCode}`}
                          alt="Ticket QR"
