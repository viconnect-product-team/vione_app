...
export const AI_KNOWLEDGE_ACCOUNTS: CandidateAccount[] = [
  ...
  },
  {
    ...
    association: "CLB Doanh Nhân CEO 1983 & Uranus Tech",
    company: "Uranus Tech",
    ...
    headline: "Lãnh đạo công nghệ Uranus Tech. Trực tiếp kiến tạo nền tảng kết nối thông minh CEO 1983 & Business Connect.",
  ...
  },
  {
    ...
    association: "Hệ Sinh Thái CEO 1983 / Doanh Nhân",
    company: "CEO 1983 Holdings",
    ...
    headline: "Tài khoản Quản trị toàn quyền nền tảng CEO 1983.",
  ...
  },
  {
    ...
    headline: "Quản trị viên điều phối vận hành hệ thống CEO 1983.",
  ...
  },
  {
    ...
    association: "Cộng đồng Doanh nhân CEO 1983",
    company: "CEO 1983 Demo Corp",
    ...
    headline: "Hội viên năng động tại cộng đồng CEO 1983. Sẵn sàng giao lưu kết nối và chia sẻ cơ hội hợp tác.",
    dealSize: "10 - 50 Tỷ VNĐ",
    phone: "0901 000 004",
    email: "demo.user@ceo1983.vn",
    verified: true,
  },
  {
    ...
    headline: "Hội viên CEO 1983 chuyên về logistics và vận chuyển hàng hóa nội địa & xuất nhập khẩu.",
    dealSize: "20 - 60 Tỷ VNĐ",
    phone: "0901 000 005",
    email: "peer1@ceo1983.vn",
    verified: true,
  },
  {
...
export function DynamicAiMatcherPanel({ initialQuery = "" }: { initialQuery?: string } = {}) {
  ...
  const matchedResults = useMemo(() => {
    ...
    const scored = AI_KNOWLEDGE_ACCOUNTS.map((acc) => {
      ...
      const icebreaker = `Kính chào anh/chị ${acc.name}, qua phân tích của CEO 1983 AI Copilot, tôi biết anh/chị là ${acc.executiveRole} chuyên về ${acc.talents[0] || acc.skills[0]}. Hiện tôi đang có nhu cầu về "${query.slice(0, 60)}...", rất mong có cơ hội được thỉnh giáo và kết nối sâu hơn cùng anh/chị.`;
