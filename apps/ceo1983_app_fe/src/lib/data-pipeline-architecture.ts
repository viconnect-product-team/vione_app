...
export const KAFKA_TOPICS: PipelineTopic[] = [
  {
    topic: "ceo1983.meeting.booking_requested",
    partitions: 6,
    replicationFactor: 3,
  ...
  {
    topic: "ceo1983.meeting.booking_decided",
    partitions: 6,
    replicationFactor: 3,
  ...
  {
    topic: "ceo1983.event.registration_submitted",
    partitions: 12,
    replicationFactor: 3,
  ...
  {
    topic: "ceo1983.payment.webhook_events",
    partitions: 8,
    replicationFactor: 3,
  ...
  {
    topic: "ceo1983.notification.dispatch_queue",
    partitions: 16,
    replicationFactor: 3,
...
export const REDIS_SPECIFICATION = {
  ...
  cachingKeys: [
    { key: "ceo1983:cache:rooms:list", ttl: "3600s", desc: "Danh sách phòng họp & trang thiết bị" },
    { key: "ceo1983:cache:events:active", ttl: "600s", desc: "Danh sách sự kiện đang mở đăng ký" },
    { key: "ceo1983:cache:user:{id}:profile", ttl: "1800s", desc: "Thông tin hội viên & danh thiếp điện tử" },
    { key: "ceo1983:lock:room:booking:{roomId}:{slot}", ttl: "30s", desc: "Distributed Lock chống trùng lịch đặt phòng" },
    { key: "ceo1983:lock:event:seat:{eventId}:{seatId}", ttl: "20s", desc: "Distributed Lock chống tranh chấp bàn tiệc/ghế ngồi" },
  ],
  pubSubChannels: [
    { name: "ceo1983:crm:to:mobile", desc: "Bắn thông báo phê duyệt, lịch họp, thay đổi phòng họp từ Web xuống Mobile" },
    { name: "ceo1983:mobile:to:crm", desc: "Đẩy phiếu đăng ký sự kiện, check-in QR, yêu cầu book phòng từ Mobile lên Web" },
    { name: "ceo1983:sync:association:{id}", desc: "Kênh dữ liệu chung của hiệp hội (tin tức, giao thương B2B)" },
  ],
};
...
const INITIAL_PIPELINE_LOGS: PipelineEventLog[] = [
  {
    ...
    channel: "kafka_topic",
    topicOrKey: "ceo1983.event.registration_submitted",
  ...
  },
  {
    ...
    topicOrKey: "ceo1983:crm:to:mobile",
  ...
  },
  {
    ...
    direction: "mobile_to_crm",
    channel: "redis_cache",
    topicOrKey: "ceo1983:lock:room:booking:room_sapphire:20260915_1430",
  ...
  },
  {
    ...
    direction: "crm_to_mobile",
    channel: "kafka_topic",
    topicOrKey: "ceo1983.notification.dispatch_queue",
