  ...
  <div class="voucher-card">
    <div class="header">
      <div>
        ...
        <div class="sub-brand">Hệ thống Quản trị Tài chính & Kế toán CEO 1983 CRM</div>
      </div>
    ...
    <div class="footer">
      Chứng từ điện tử được khởi tạo tự động từ hệ thống CEO 1983 CRM. Mã tra cứu: ${voucherCode}
    </div>
  </div>
