...
export function getInsecureContextHelp(): {
  ...
  return {
    ...
    steps: [
      ...
      "Tải lại trang và cho phép quyền truy cập Camera & Micro.",
    ],
  };
}
 ...
 */
export function createMockVideoStream(label: string = "Đối tác CEO 1983"): MediaStream {
  ...
  const render = () => {
    ...
    ctx.fillText("CEO 1983 VIRTUAL CAMERA • SIMULATED FEED", centerX, 345);
