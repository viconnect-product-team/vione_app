...
export const INITIAL_MEETING_ROOMS: MeetingRoom[] = [
  ...
  },
  {
    ...
    type: "online",
    capacity: 500,
    location: "Nền tảng Trực tuyến Đám mây CEO 1983 Cloud",
...
const STORAGE_KEY_ROOMS = "ceo1983_meeting_rooms_registry";
const STORAGE_KEY_BOOKINGS = "ceo1983_meeting_room_bookings";
