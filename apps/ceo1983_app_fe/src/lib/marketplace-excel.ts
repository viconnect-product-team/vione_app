...
export async function downloadProductTemplateExcel(): Promise<void> {
  const workbook = new ExcelJS.Workbook();
  workbook.creator = "CEO 1983 - B2B Marketplace";
  ...
  const sampleData = [
    {
      stt: 1,
      title: "Phần mềm Quản lý Doanh nghiệp ERP Cloud",
      category: "Công nghệ & Phần mềm",
      price: 25000000,
      originalPrice: 35000000,
      unit: "Năm",
      company: "Công ty Công nghệ Số 1983",
      sellerName: "Nguyễn Văn An",
      sellerPhone: "0912345678",
      description: "Giải pháp quản trị tổng thể doanh nghiệp B2B: Kế toán, bán hàng, kho vận.",
      websiteUrl: "https://ceo1983.vn",
    ...
    },
    {
      ...
      description: "Tư vấn rà soát hợp đồng kinh tế, cấu trúc thuế và bảo vệ quyền sở hữu trí tuệ.",
      websiteUrl: "https://ceo1983.vn/consulting",
