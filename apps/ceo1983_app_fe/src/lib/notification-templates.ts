/**
 * Multi-Channel Fixed Template Engine for CEO 1983 Platform
 * 
 ...
 * 4. Cross-App Realtime Message Flow (2-way sync between Web CRM and Member Mobile App)
 */
...
export const NOTIFICATION_TEMPLATES: NotificationTemplate[] = [
  // ── 1. ROOM BOOKING WORKFLOW ─────────────────────────────────────────
  {
    ...
    variables: [
      ...
      { key: "approvalUrl", label: "Link duyệt nhanh", example: "https://ceo1983.vn/meetings?tab=bookings&id=BK-1983" },
    ],
    isLocked: true,
...
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 640px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06);">
  <div style="background: linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%); padding: 32px 28px; text-align: left; color: #ffffff;">
    ...
    <p style="margin: 8px 0 0; font-size: 14px; color: #94a3b8;">Hệ thống CEO 1983 CRM - Thông báo phân quyền quản trị phòng họp</p>
  </div>
...
`,
  },
  {
    ...
    variables: [
      ...
      { key: "rebookUrl", label: "Link đặt lại", example: "https://ceo1983.vn/meetings?tab=book" },
    ],
    isLocked: true,
    updatedAt: "2026-09-12",
    htmlBody: `
...
`,
  },
  {
    ...
    variables: [
      ...
      { key: "receiptDownloadUrl", label: "Link tải biên lai PDF", example: "https://ceo1983.vn/finance/receipt?id=TXN-99120" },
    ],
    isLocked: true,
    updatedAt: "2026-09-12",
    htmlBody: `
...
`,
  ...
  // ── 3. EVENT NOTIFICATION & TICKETING WORKFLOW ───────────────────────
  {
    ...
    variables: [
      ...
      { key: "registrationUrl", label: "Link đăng ký", example: "https://ceo1983.vn/events/evt-2026" },
    ],
    isLocked: true,
    updatedAt: "2026-09-12",
    htmlBody: `
...
`,
  },
  {
    ...
    variables: [
      ...
      { key: "qrCodeDataUrl", label: "Mã QR Check-in", example: "https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=CEO1983-TKT-8839-GL" },
    ],
    isLocked: true,
    updatedAt: "2026-09-12",
    htmlBody: `
...
`,
  ...
  // ── 4. CROSS-APP REALTIME MESSAGING WORKFLOW ─────────────────────────
  {
    ...
    category: "cross_app",
    name: "Thông Điệp Đồng Bộ 2 Chiều Giữa CRM và App Hiệp Hội CEO 1983",
    description: "Đảm bảo luồng dữ liệu 2 chiều giữa Web CRM Quản trị và App Hội viên của Hiệp hội CEO 1983.",
    targetRole: "members",
    channels: ["in_app", "push"],
    subject: "[CEO 1983] Tin nhắn mới từ {{senderName}} ({{associationName}})",
    ...
    variables: [
      ...
      { key: "threadUrl", label: "Link mở hội thoại", example: "ceo1983://chat/thread/TH-1983-09" },
    ],
    isLocked: true,
    updatedAt: "2026-09-12",
    htmlBody: `
<div style="font-family: 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 14px; padding: 24px;">
  <div style="font-size: 12px; font-weight: 700; color: #2563eb; text-transform: uppercase; margin-bottom: 8px;">{{associationName}} - App Hội Viên</div>
