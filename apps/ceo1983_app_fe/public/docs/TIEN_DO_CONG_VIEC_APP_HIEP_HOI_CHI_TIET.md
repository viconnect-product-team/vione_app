...
**Dự án:** CEO 1983 Ecosystem · **Phân hệ:** Hợp Nhất 100% **App Hội Viên** & **Web CRM Quản Trị**  
...
| STT | Mã Task | Tên Chức Năng / Task | Người Thực Hiện | Mức Độ | Giao Diện (Màn Hình) | API Mapped | Khởi tạo | Inprocess | Done | Ghi Chú |
|:---:|---|---|:---:|:---:|---|---|:---:|:---:|:---:|:---:|
| 34 | **EVT-01** | CRM Modal Tạo sự kiện với mẫu Template theo loại hình (Forum, Workshop, Networking, Training) | Phạm Văn Vũ | **Cao** | Tạo Sự Kiện CRM (/events/new, EventWizard) | `apps/ceo1983_app_fe/src/lib/event-type-templates.ts, EventWizard.tsx` |  |  | ✅ | Chuẩn hóa quy trình tạo sự kiện chuyên nghiệp cho Ban Sự Kiện CLB. |
...
| STT | Mã Task | Tên Chức Năng / Task | Người Thực Hiện | Mức Độ | Giao Diện (Màn Hình) | API Mapped | Khởi tạo | Inprocess | Done | Ghi Chú |
|:---:|---|---|:---:|:---:|---|---|:---:|:---:|:---:|:---:|
| 52 | **NOTIF-01** | Tách biệt độc lập 100% luồng Thông báo cho Hiệp hội CEO 1983 | Phạm Văn Vũ | **Cao** | Màn hình Thông báo (/association/notifications & /notifications) | `GET /api/connect-app/notifications, GET /api/connect-app/member/notifications` |  |  | ✅ | Đảm bảo ứng dụng hoạt động độc lập tuyệt đối, bảo mật dữ liệu thông báo nội bộ. |
...
| STT | Mã Task | Tên Chức Năng / Task | Người Thực Hiện | Mức Độ | Giao Diện (Màn Hình) | API Mapped | Khởi tạo | Inprocess | Done | Ghi Chú |
|:---:|---|---|:---:|:---:|---|---|:---:|:---:|:---:|:---:|
| 89 | **AUTH-CRM-01** | Giao diện đăng nhập chuẩn doanh nghiệp Xanh-Trắng, đồng bộ thương hiệu CEO 1983 | Phạm Văn Vũ | **Cao** | Màn hình Đăng nhập CRM (/auth) | `POST /api/auth/login` |  |  | ✅ | Giao diện thương hiệu Xanh-Trắng sang trọng kèm huy hiệu bảo mật ShieldCheck. |
...
| 99 | **MEM-CRM-04** | Thao tác Phê duyệt (Approve) tự động cấp mã hội viên M1983-xxx và sinh tài khoản đăng nhập | Phạm Văn Vũ | **Cao** | Drawer Chi Tiết Hội Viên (/members) | `POST /api/members/:id/approve` |  |  | ✅ | Tự động tạo account trên hệ thống và liên kết member_id chính xác. |
