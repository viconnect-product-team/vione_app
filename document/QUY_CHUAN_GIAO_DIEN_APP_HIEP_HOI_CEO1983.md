...
- **Nút "Chỉnh sửa":**
  - Đặt nằm ngay chính giữa thẻ hội viên.
...
> **Lưu ý kỹ thuật:** Tài khoản có email chứa tiền tố quản trị hoặc role `admin` / `superadmin` / `board_of_directors` mặc định luôn có toàn quyền hiển thị nút Quét QR và các chức năng giám sát sự kiện.
