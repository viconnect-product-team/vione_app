  ...
  const modules = [
    ...
    },
    {
      ...
      features: [
        {
          id: 'B2B-01',
          name: 'Sàn đăng tin Cơ hội Giao thương B2B (Chào mua, Chào bán, Đầu tư)',
          screen: 'Màn hình Cơ hội B2B (/association/opportunities)',
          api: 'GET /api/connect-app/opportunities, POST /api/connect-app/opportunities',
          devDate: '13/09/2026',
          contribution: 'Phân hệ sàn giao thương B2B nội khối, gắn thẻ Chào Mua/Chào Bán/Hợp Tác, định giá hợp đồng dự kiến.',
          team: 'Backend Core',
          priority: 'Cao (P1)',
          status: 'Đã hoàn thành',
          pct: 100,
        ...
        {
          id: 'B2B-02',
          name: 'Popup Đăng tin giao thương & Đính kèm hồ sơ năng lực / hình ảnh',
          screen: 'Popup Tạo bài viết B2B (/association/opportunities)',
          api: 'POST /api/connect-app/opportunities, POST /api/upload/file',
          devDate: '14/09/2026',
          contribution: 'Form đăng tin đa phương tiện, tải ảnh lên MinIO S3 và cơ chế kiểm duyệt nội dung an toàn.',
          team: 'Fullstack Team',
          priority: 'Trung bình (P2)',
          status: 'Đã hoàn thành',
          pct: 100,
          note: 'Tích hợp upload ảnh lên kho lưu trữ MinIO S3, duyệt bài tự động hoặc qua Ban Xúc Tiến.',
        },
        {
          id: 'B2B-03',
          name: 'Gian hàng sản phẩm & Bố cục nút "Đăng sản phẩm" tối ưu',
          screen: 'Màn hình Sản phẩm (/association/products)',
          api: 'GET /api/connect-app/products, POST /api/connect-app/products',
          devDate: '15/09/2026 - 16/09/2026',
          contribution: 'Tái thiết kế giao diện: Chuyển nút "Đăng sản phẩm" xuống cạnh thanh tìm kiếm, nâng cấp thẻ sản phẩm với ảnh lớn sắc nét, huy hiệu chiết khấu nội bộ và nút nhận báo giá nhanh.',
          team: 'Frontend UI/UX',
          priority: 'Cao (P1)',
          status: 'Đã hoàn thành',
          pct: 100,
    ...
    },
    {
      ...
      features: [
        {
          id: 'EVT-01',
          name: 'Giao diện Sự kiện Full-Image chuẩn điện ảnh (Text nằm trọn trong ảnh)',
          screen: 'Màn hình Sự kiện (/association/events & /association/index)',
          api: 'GET /api/events, POST /api/events/:id/register',
          devDate: '15/09/2026 - 16/09/2026',
          contribution: 'Đại tu UI Sự kiện: Toàn bộ tiêu đề, thời gian, tên sự kiện được đưa vào bên trong banner tỷ lệ 16:9 với lớp phủ gradient tối sang trọng, gắn liền dải thông số 3 cột (Thời gian, Địa điểm, Đối tượng), loại bỏ nút bấm thừa dưới chân thẻ.',
          team: 'Frontend UI/UX',
          priority: 'Khẩn cấp (P0)',
          status: 'Đã hoàn thành',
          pct: 100,
          note: 'Khớp 100% bản vẽ chuẩn thiết kế cao cấp, đồng bộ trên cả trang chủ lẫn trang danh sách sự kiện.',
        },
        {
          id: 'EVT-02',
          name: 'Check-in bằng mã QR tại cửa hội trường & Quét mã điểm danh',
          screen: 'Popup QR Check-in (/association/card, /history)',
          api: 'POST /api/events/:id/checkin, GET /api/events/:id/attendees',
          devDate: '14/09/2026',
          contribution: 'Sinh vé điện tử có QR định danh vé mời, quét camera check-in tự động xác nhận tham dự sự kiện.',
          team: 'Fullstack Team',
          priority: 'Cao (P1)',
          status: 'Đã hoàn thành',
          pct: 95,
          note: 'Sinh mã QR điểm danh động và giao diện camera scanner đã hoàn thiện; Đã test thành công với camera giả lập.',
        },
        {
          id: 'EVT-03',
          name: 'Biểu quyết & Bầu cử trực tiếp đại hội (Thời gian thực)',
          screen: 'Màn hình Biểu quyết (/association/voting)',
          api: 'GET /api/voting/sessions, POST /api/voting/:id/vote, GET /api/voting/:id/results',
          devDate: '15/09/2026',
          contribution: 'Module bỏ phiếu đại biểu kín, mã hóa kết quả, bảng điều khiển kết quả biểu quyết thời gian thực.',
          team: 'Backend & Security',
          priority: 'Cao (P1)',
          status: 'Đã hoàn thành',
          pct: 100,
          note: 'Bỏ phiếu bí mật, mã hóa kết quả, tự động tổng hợp biểu đồ trực tiếp trên màn hình LED.',
        },
      ],
    },
    {
