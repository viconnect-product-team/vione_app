$files = @(
  ...
  "document\SLIDE_THUYET_TRINH_HE_SINH_THAI_CEO1983.pptx",
  "document\SLIDE_THUYET_TRINH_HE_SINH_THAI_CEO1983.html",
  "document\SLIDE_THUYET_TRINH_HE_SINH_THAI_CEO1983.md",
